...
description: Proficient in python (numpy, sklearn, pandas) and in R. I have gained classroom and real world experience using 
            both in various projects thorughout my studies, some of which you can find on this site.
draft: false
...
In my opinion the histogram is the easiest to interpret and gives a rapid and efficient idea of the variability of the data. The density chart is similar but can be a mit misleading for certain animals (like ferret).
